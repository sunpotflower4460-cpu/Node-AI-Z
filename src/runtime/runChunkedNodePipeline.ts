import type { ChunkedPipelineStage } from '../intelligence/ingest/chunkTypes'
...
import { deriveSomaticSignature, findRelevantSomaticMarkers, computeSomaticInfluence } from '../intelligence/somatic'
